      ...
      <motion.div
        ...
        <div>
          <div className='grid grid-cols-1 gap-2 p-5'>
            <Typewriter text='$$ npm run start' className='text-[14px] font-mono text-green-400/90' onComplete={() => setTypingDone(true)} speed={100} />
            ...
            <div className='text-neutral-300' style={fadeStyle(2)}>
              ...
              <span className='text-neutral-300'>{' '}TypeScript compiled successfully</span>
            </div>
