          ...
          <div className='flex flex-col gap-7 p-2 *:bg-neutral-100 *:shadow-[0px_0px_4px_0px_rgba(0,0,0,0.25)] laptop:col-span-full overflow-hidden laptop:col-start-8'>
            ...
            <AnimationCard
              ...
              <div
                ...
                <h2
                  className="mb-1.5 font-display text-2xl font-bold leading-8 text-primary-900">
                  Movies App
                </h2>

                <p className="text-sm text-primary-900">
                  Aplicação web desenvolvida com React + TypeScript para busca e navegação de filmes
                </p>
            ...
            <AnimationCard
              ...
              <div
                ...
                <p className="text-sm text-primary-900">
                  Projeto desenvolvido em React, com temperatura atual baseada na localização do usuário, além de modo claro/escuro
                </p>
            ...
            <AnimationCard
              ...
              <div
                ...
                <p className="text-sm text-primary-900">
                  Um aplicativo de gerenciamento de tarefas (CRUD) desenvolvido em JavaScript puro
                </p>
