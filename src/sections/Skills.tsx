      ...
      <div className="relative overflow-hidden bg-neutral-100 py-20">
        ...
        <Container>
          <div className="layout-grid">
            ...
            <div className="flex flex-col gap-7 px-1 py-4 *:bg-blue-100 *:shadow-[0px_0px_4px_0px_rgba(0,0,0,0.25)] laptop:col-span-full overflow-hidden laptop:col-start-8">
              <Card classe={'relative p-5 rounded-2xl'} delay={0.2}>
                ...
                <img
                  src={CodeIcon}
                  className="w-16 h-12 text-primary-900 mb-3.5"
                />
                <h2 className="text-primary-900 mb-2.5 font-display text-2xl font-bold leading-8">
                  Linguagens
                </h2>
