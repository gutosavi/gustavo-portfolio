      ...
      <Container>
        <div className="layout-grid mb-10">
          ...
          >
            ...
            <h2 className="text-5xl font-display font-bold text-primary-900 mb-10 laptop:text-6xl">
            ...
            <div className="flex flex-col gap-4 text-primary-900 font-display text-lg leading-8 laptop:text-2xl">
              <p>
                ...
                <span className="text-primary-500">Tailwind CSS</span>, criando
                aplicações web modernas com foco em componentização,{' '}
                <span className="text-primary-500">responsividade</span> e{' '}
                <span className="text-primary-500">experiência do usuário</span>
                .
              </p>
              <p>
